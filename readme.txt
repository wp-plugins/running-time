...
**User Manual for Running Time 1.1b1**
...
*Running Time 1.1b1 has been tested in Wordpress 2.1, but it should work in Wordpress 2.0 with no problems, though untested.*
